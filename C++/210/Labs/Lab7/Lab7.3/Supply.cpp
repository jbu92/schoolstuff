...
Supply::Supply(){
	...
	quant = 0;
	price = 0;
	cout << "In default constructor of Supply\n";
}
Supply::Supply(string desc, int stockNo, int quant, double price){
	...
	this->quant = quant;
	this->price = price;
	cout << "In full constructor of Supply\n";
}
Supply::Supply(const Supply& s2){
	...
	quant = s2.quant;
	price = s2.price;
	cout << "In copy constructor of Supply\n";
}
Supply::~Supply(){
	cout << "In destructor of Supply. Price: " << price << endl;
}
void Supply::print(){
